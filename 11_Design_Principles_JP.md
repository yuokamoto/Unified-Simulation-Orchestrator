...
- この原則は本文書群のほぼすべての章（[12](./12_Layering_and_ML_Boundary_JP.md)〜[16](./16_Current_Status_and_Rollout_Approach_JP.md)、および[19](./19_Snapshot_MetaData_and_Reproduction_Info_JP.md)でも明示的に）に通底する基準線であり、個別の設計判断に迷ったときはここに立ち戻る。
